...
- ✅ **Главный экран:** стартовая точка с картинкой (AI/робот), названием приложения и раскрывающимися блоками по темам (первый блок — «Промптинг»: Чат, Обсуждение, Температура); на экранах Чат, Обсуждение и Температура — кнопка «Назад» на главный
...
При запуске открывается **главный экран**: картинка на тему AI и робота, название «Ai Advent Challenge With Love» и раскрывающиеся блоки по темам. Раскройте блок **«Промптинг»** и выберите экран: Чат, Обсуждение или Температура. На этих экранах кнопка **«Назад»** возвращает на главный экран.
